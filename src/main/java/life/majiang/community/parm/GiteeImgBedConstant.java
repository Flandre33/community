package life.majiang.community.parm;
...
public interface GiteeImgBedConstant {
     ...
     */
    String ACCESS_TOKEN = "7b0c85c8596aa1e97a5ce8d1c940ae21";

            /**
             * 仓库所属地址  这个是您的私人用户名 具体请参考创建仓库时的注意事项
             */
    String OWNER = "flandre33";
    /**
     * TODO：仓库名称  这里是您的仓库名称
     */
    String REPO_NAME = "community";
            /**
             * TODO：上传图片的message
             */
     ...
     * TODO：文件前缀
     */
    String IMG_FILE_DEST_PATH = "/src/main/resources/static/images/";
     ...
     */
    String GITPAGE_REQUEST_URL = "http://flandre33.gitee.io/community";
